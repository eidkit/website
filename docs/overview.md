...
- **Autentificare activă** — challenge/response cu cheia de autentificare a cipului, confirmând că cipul este autentic și nu a fost clonat; returnează material criptografic brut în `CeiIdentityClaim` pentru verificare backend
